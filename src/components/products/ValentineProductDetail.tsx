...
const MAGIC_DETAILS = [
  ['Step 1 · H1', 'ครีมยืดผมขั้นตอนที่ 1 สำหรับเส้นผมสุขภาพดี · 500 ml', 'ใช้เวลา 15–20 นาที แล้วล้างออก', 'ไฮโดรไลซ์คอลลาเจน · ไฮโดรไลซ์เคราติน · ไฮโดรไลซ์ซิลค์'],
  ['Step 1 · D1', 'ครีมยืดผมขั้นตอนที่ 1 สำหรับเส้นผมเสีย · 500 ml', 'ใช้เวลา 10–15 นาที แล้วล้างออก', 'ไฮโดรไลซ์คอลลาเจน · ไฮโดรไลซ์เคราติน · ไฮโดรไลซ์ซิลค์'],
  ...
  return <>
    <section className="mx-auto grid max-w-[1180px] border-y border-brand-gold/30 bg-brand-card md:grid-cols-[.88fr_1.12fr]" lang="th">
      <div className="flex flex-col justify-center px-6 py-10 md:px-14 md:py-16">
        ...
        <p className="mt-5 text-xs font-bold uppercase tracking-[.18em] text-brand-champagne">Magic Straight System</p>
        <h1 className="mt-4 font-heading text-4xl font-bold leading-[1.16] tracking-tight text-brand-white md:text-6xl">ระบบยืดผม<br />2 ขั้นตอน<br />สำหรับช่างมืออาชีพ</h1>
        <p className="mt-5 max-w-md leading-relaxed text-brand-gray-light">เลือก Step 1 ตามสภาพเส้นผม และทำงานต่อด้วย Step 2 หลังล้างขั้นตอนแรก</p>
      </div>
      <div className="border-t border-brand-gold/30 p-3 md:border-l md:border-t-0 md:p-7">
        <div className="grid grid-cols-2 gap-4 px-4 pt-3 text-center text-[10px] font-bold tracking-[.13em] text-brand-champagne"><span>STAGE 1 · STRAIGHT CREAM</span><span>STAGE 2 · NEUTRALIZER</span></div>
        <img alt="Valentine Magic Straight System: H1, D1, C2 และ L2" className="h-auto w-full object-contain" fetchPriority="high" height="1050" src={assetPath(`/products/${product.slug}/hero.webp`)} width="1500" />
      </div>
    </section>
...
function LppDetail({ product }: { product: Product }) {
  return <>
    ...
    <section className="mx-auto max-w-[1180px] px-4 py-4 md:px-6 md:py-8" lang="th"><div className="bg-brand-card px-6 py-9 md:px-14 md:py-12"><p className="text-xs font-bold uppercase tracking-[.18em] text-brand-champagne">Professional use</p><h2 className="mt-3 font-heading text-3xl font-bold text-brand-white">สรุปการใช้</h2><div className="mt-7"><DetailRows rows={[["ดูแลที่บ้าน", "หลังสระ ใช้และทิ้งไว้อย่างน้อย 5 นาที"], ["ซาลอนแบบเดี่ยว", "ใช้เวลาประมาณ 20 นาที"], ["ก่อนดัดหรือทำสี", "ใช้เตรียมบริเวณผมเสียก่อนดัดหรือทำสี โดยฉลากไม่ได้ระบุเวลาให้ทิ้งไว้"], ["ความปลอดภัย", "ใช้ภายนอกเท่านั้น หลีกเลี่ยงการสัมผัสดวงตา เก็บให้พ้นมือเด็ก และเก็บในที่เย็นและมืด"]]} /></div></div></section>
    <section className="mx-auto max-w-[1180px] px-4 py-8 md:px-6 md:py-14" lang="th"><div className="border-t border-brand-gold/30 pt-10"><p className="text-xs font-bold uppercase tracking-[.18em] text-brand-champagne">Product details</p><h2 className="mt-3 font-heading text-3xl font-bold text-brand-white">รายละเอียดผลิตภัณฑ์</h2></div><div className="mt-8 grid gap-4 md:grid-cols-2"><article className="border border-brand-gold/25 bg-brand-card p-6"><h3 className="font-heading text-xl font-bold">วัตถุประสงค์</h3><p className="mt-3 leading-relaxed text-brand-gray-light">ทรีตเมนต์โปรตีนแบบล้างออกสำหรับเส้นผมเสีย ขนาด 500 ml</p></article><article className="border border-brand-gold/25 bg-brand-card p-6"><h3 className="font-heading text-xl font-bold">ส่วนประกอบที่ยืนยัน</h3><p className="mt-3 leading-relaxed text-brand-gray-light">น้ำมันมะกอก อาร์แกน อะโวคาโด · ไฮโดรไลซ์เคราติน คอลลาเจน ซิลค์ · Sodium PCA · Panthenol</p></article></div></section>
  </>;
}
