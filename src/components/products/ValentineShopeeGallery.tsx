...
export function ValentineShopeeGallery({ slug, magic = false }: { slug: string; magic?: boolean }) {
  ...
  const set = VALENTINE_GALLERY_SETS[code];
  return <section className="mx-auto max-w-[1180px] px-4 py-10 md:px-6 md:py-16" lang="th" aria-labelledby="shopee-gallery-title">
    <div className="border-t border-brand-gold/30 pt-10"><p className="text-xs font-bold uppercase tracking-[.18em] text-brand-white">Shopee visual guide</p><h2 className="mt-3 font-heading text-3xl font-bold text-brand-white" id="shopee-gallery-title">ภาพรายละเอียดผลิตภัณฑ์</h2><p className="mt-3 max-w-2xl leading-relaxed text-brand-white">ภาพจากรายการสินค้า Valentine Professional เพื่อดูฉลาก วิธีใช้ และรายละเอียดผลิตภัณฑ์ได้อย่างชัดเจน</p></div>
