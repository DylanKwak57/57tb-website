...
export const SERVICES: Service[] = [
  ...
  { id: 'digital-perm', category: 'PERM', name: { th: 'Digital Perm', en: 'Digital Perm', ko: 'Digital Perm' }, description: { th: 'Korean digital perm', en: 'Korean digital perm', ko: '디지털 펌' }, prices: { junior: 700, stylist1: 900, stylist2: 1200, stylist3: 1500 }, duration: '3 hours', popular: true },
  { id: 's-perm', category: 'PERM', name: { th: 'S Perm', en: 'S Perm', ko: 'S Perm' }, description: { th: 'S-curl perm', en: 'S-curl perm', ko: 'S컬 펌' }, prices: { junior: 900, stylist1: 1200, stylist2: 1500, stylist3: 1800 }, duration: '3 hours' },
  { id: 'rebonding', category: 'PERM', name: { th: 'Rebonding', en: 'Rebonding', ko: 'Rebonding' }, description: { th: 'Hair straightening', en: 'Hair straightening', ko: '매직 스트레이트' }, prices: { junior: 900, stylist1: 1200, stylist2: 1500, stylist3: 1800 }, duration: '3-4 hours' },
  ...
  { id: 'volume-magic', category: 'PERM', name: { th: 'Volume Magic', en: 'Volume Magic', ko: 'Volume Magic' }, description: { th: 'Volume magic straight perm', en: 'Volume magic straight perm', ko: '볼륨 매직' }, prices: { junior: 1200, stylist1: 1500, stylist2: 1800, stylist3: 2100 }, duration: '3-4 hours', popular: true },
  ...
  { id: 'color-gosen', category: 'COLOR', name: { th: 'Color (Gosen)', en: 'Color (Gosen)', ko: 'Color (Gosen)' }, description: { th: 'Full color with Gosen', en: 'Full color with Gosen', ko: '풀 염색 (고센)' }, prices: { junior: 700, stylist1: 900, stylist2: 1200, stylist3: 1500 }, duration: '2-3 hours', popular: true },
  ...
  { id: 'color-nigao', category: 'COLOR', name: { th: 'Color (Nigao)', en: 'Color (Nigao)', ko: 'Color (Nigao)' }, description: { th: 'Full color with Nigao', en: 'Full color with Nigao', ko: '풀 염색 (니가오)' }, prices: { junior: 1500, stylist1: 1800, stylist2: 2100, stylist3: 2400 }, duration: '2-3 hours' },
  ...
  { id: 'damage-control', category: 'TREATMENT', name: { th: 'Damage Control', en: 'Damage Control', ko: 'Damage Control' }, description: { th: 'Damage control treatment', en: 'Damage control treatment', ko: '데미지 컨트롤 트리트먼트' }, prices: { junior: 500, stylist1: 500, stylist2: 500, stylist3: 500 }, duration: '30 min' },
  ...
  { id: 'one-shot-service', category: 'TREATMENT', name: { th: 'One Shot Service', en: 'One Shot Service', ko: 'One Shot Service' }, description: { th: 'Add-on (excl. shampoo & dry)', en: 'Add-on (excl. shampoo & dry)', ko: '원샷 서비스 (샴푸&드라이 불포함)' }, prices: { junior: 200, stylist1: 200, stylist2: 200, stylist3: 200 }, duration: '20-40 min' },
  { id: 'ann-treatment', category: 'TREATMENT', name: { th: 'Ann Treatment Service', en: 'Ann Treatment Service', ko: 'Ann Treatment Service' }, description: { th: 'Add-on (excl. shampoo & dry)', en: 'Add-on (excl. shampoo & dry)', ko: '앤 트리트먼트 서비스 (샴푸&드라이 불포함)' }, prices: { junior: 500, stylist1: 500, stylist2: 500, stylist3: 500 }, duration: '30-50 min' },
