...
export const REVIEWS: Review[] = [
  {
    id: 'r1',
    name: { th: 'Itzriya A.', en: 'Itzriya A.', ko: 'Itzriya A.' },
    rating: 5,
    text: {
      th: 'ร้านใหญ่ ระบบจัดการคิวดี ควรจองผ่าน LINE ก่อน พนักงานยิ้มแย้ม สระดีมือเบา นวดหัว ช่างพราวใจดี สุภาพ ใจเย็น จะกลับมาอีกค่ะ',
      en: 'Large salon with excellent queue management. Recommend booking through LINE. Friendly staff, gentle shampoo with head massage. Stylist Praw was kind, polite, and patient. Will come back!',
      ko: '큰 매장에 대기 관리가 잘 되어 있어요. LINE 예약 추천해요. 직원들이 친절하고 샴푸와 두피 마사지가 편안해요. 미용사 쁘라우가 친절하고 정중해요. 다시 올게요!',
    },
    service: 'Cut',
    date: '2025-08-24',
  },
  ...
  {
    id: 'r4',
    name: { th: 'พัชรีวรรณ วัฒนกูล', en: 'Patchareewan W.', ko: 'Patchareewan W.' },
    rating: 5,
    text: {
      th: 'ทางร้านบริการดีมากค่ะ ช่างเฟิร์นน่ารัก ใส่ใจดีมากค่ะ',
      en: 'The salon provides excellent service. Stylist Fern is lovely and very attentive.',
      ko: '매장 서비스가 정말 좋아요. 미용사 펀이 친절하고 세심하게 신경 써줘요.',
    },
    service: 'Cut',
    date: '2024-12-31',
  },
  {
    id: 'r5',
    name: { th: 'เบญจมาศ คณาพันธุ์', en: 'Benjamas K.', ko: 'Benjamas K.' },
    rating: 5,
    text: {
      th: 'รับบริการทำสีผม ร้านให้บริการดี ให้คำแนะนำดีค่ะ ทำกับช่างแบงค์ ตรงปกจ้า',
      en: 'Got hair coloring service. The shop provides good service with great advice. Done by stylist Bank, exactly as expected.',
      ko: '헤어 컬러링 서비스를 받았어요. 좋은 서비스와 조언을 해줘요. 뱅크 미용사가 해줬는데 기대한 대로 나왔어요.',
    },
    service: 'Color',
    date: '2024-12-31',
  },
